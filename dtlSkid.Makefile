...
ifneq ($(strip $(CWMCWS04CTRLPLC001_DEP_VERISON)),)
cwmcws04ctrlplc001_VERSION=$(CWMCWS04CTRLPLC001_DEP_VERISON)
endif
...
# SOURCES += $(APPSRC)/aCalcPerform.c
 ...
 SOURCES += $(APPSRC)/communication_management.st
 SOURCES += $(APPSRC)/cooling_statemachine.st
